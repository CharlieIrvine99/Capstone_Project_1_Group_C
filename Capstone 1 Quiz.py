...
class Question:
    ...
    def askQuestion(self):
        ...
        if userAnswer.upper() in self.correctAnswer:
            ...
            print(f"That is incorrect. You can however have one more attempt, "
                  f"you're still playing for {self.reducedBounty} point.")
            ...
            if userAnswer2.upper() in self.correctAnswer:
                ...
                print(f"Sorry, you FAILED! The correct answer was {correct_answer_formatted}\n"
    ...
    def askFinalQuestion(self):
        ...
        if userAnswer.upper() in self.correctAnswer:
            ...
            print(
                f"That is incorrect. You can however have one more attempt, you're still playing for {self.reducedBounty} point."
            )
            userAnswer2 = input("Enter your answer here: ")
            if userAnswer2.upper() in self.correctAnswer:
                pointTotal += self.reducedBounty
...
def userPickName():
    ...
    nameCorrect = input(f"Okay, so {name.capitalize()} is your name?\nPlease re-enter your name to confirm and continue: ")
...
time.sleep(timeInbetweenText)
print("If you choose the Hard quiz, you will get 10 points, and only 5 if you need to try again.\n"
...
easyQuestionTwo = Question("2", "What is the capital of France?",
                           {"A": "London", "B": "Madrid", "C": "Berlin", "D": "Paris"},
                           ["D", "PARIS"], 5, 1)
...
easyQuestionFour = Question("4", "Who won the most gold medals in history?",
                            {"A": "Michael Phelps", "B": "Usain Bolt", "C": "Larisa Latynina", "D": "Christ Hoy"},
                            ["A", "MICHAEL PHELPS"], 5, 1)

easyQuestionFive = Question("5", "In the game of chess, which piece can only move diagonally?",
                            {"A": "Rook", "B": "Knight", "C": "Bishop", "D": "King"},
                            ["C", "ROOK"], 5, 1)

hardQuestionOne = Question("1", "What is it called when a function is defined in a class?",
                           {"A": "Module", "B": "Class", "C": "Function", "D": "Method"},
                           ["D", "METHOD"], 10, 5)

hardQuestionTwo = Question("2", "Who developed the Python language?",
                           {"A": "Albert Einstein", "B": "Bill Gates", "C": "Wick Von Rossum", "D": "Gregor Mendel"},
                           ["C", "WICK VON ROSSUM"], 10, 5)

hardQuestionThree = Question("3", "Which of the following is the correct extension of the Python file?",
                             {"A": ".python", "B": ".py", "C": ".p", "D": "None of these"},
                             ["B", ".PY"], 10, 5)

hardQuestionFour = Question("4", "What do we use to define a block of code in Python?",
                            {"A": "Indentation", "B": "Key", "C": "Curly Brackets", "D": "Square Brackets"},
                            ["A", "INDENTATION"], 10, 5)

hardQuestionFive = Question("5", "Who has the most PyCharm?",
                            {"A": "Harbi", "B": "Delawar", "C": "Charlie", "D": "Merbaan"},
                            ["C", "CHARLIE"], 10, 5)
...
def easyQuiz():
    ...
    print("Congratulations on completing the quiz! Your final score is...\n*Drumroll*")
    timing(5)
    print(f"{pointTotal}out of 50!\nThank you very much for playing {name}!")
...
def chooseDifficulty():
    ...
    if difficulty.upper() == "HARD":
        ...
        chooseDifficulty()  # Here it restarts the loop if the user entered it wrong.
